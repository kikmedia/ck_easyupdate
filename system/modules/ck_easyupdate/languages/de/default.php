...
$GLOBALS['TL_LANG']['easyupdate']['readme']['text4'] = 'Getestet wurde eine Installation bis zur Contao Version 2.11.9 - es sollte jedoch auch keine Probleme mit neueren Versionen geben. Die Funktionen wurden an das neue Request-Token-System ab Contao 2.10.x angepasst.
														Die Funktionsfähigkeit mit TYPOlight vor der Version 2.5 wurde nicht getestet, könnte aber funktionieren.
														Wenn eine Versionsnummer X.X.X erscheint, dann ist wahrscheinlich die ZIP-Datei beschädigt. Bei Contao-Versionen uter 2.10 ist die UNterstützung nur eingeschränkt - das Changelog wird nicht angezeigt, da sich hier das Dateiformat geändert hat.';
?>
